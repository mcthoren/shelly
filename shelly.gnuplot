...
plot dat_f_pp000 using 1:3 title 'apt lights voltage (VAC)' with lines lw 1, \
	dat_f_pp001 using 1:3 title 'main outlets voltage (VAC)' with lines lw 1, \
	dat_f_pp002 using 1:3 title 'kitchen outlets - window side (VAC)' with lines lw 1, \
	dat_f_pp003 using 1:3 title 'kitchen outlets - sink side (VAC)' with lines lw 1, \
	dat_f_pp004 using 1:3 title 'washing machine (VAC)' with lines lw 1, \
	dat_f_pp005 using 1:3 title 'bathroom razor (VAC)' with lines lw 1, \
	dat_f_pp006 using 1:3 title 'bathroom outlets (VAC)' with lines lw 1
...
plot	dat_f_pp000 using 1:5 title 'apt lights current (A)' with lines lw 2, \
	dat_f_pp005 using 1:5 title 'bathroom razor current (A)' with lines lw 2, \
	dat_f_pp006 using 1:5 title 'bathroom outlets current (A)' with lines lw 2, \
	dat_f_pl using 1:7 title 'plant light current (A)' with lines lw 2, \
	dat_f_bk using 1:7 title 'balcony lights current (A)' with lines lw 2
...
plot	dat_f_pp000 using 1:7 title 'apt lights power (W)' with lines lw 2, \
	dat_f_pp005 using 1:7 title 'bathroom razor power (W)' with lines lw 2, \
	dat_f_pp006 using 1:7 title 'bathroom outlets power (W)' with lines lw 2, \
	dat_f_pl using 1:3 title 'plant light power (W)' with lines lw 2, \
	dat_f_bk using 1:3 title 'balcony lights power (W)' with lines lw 2
